  ...
  return (
    <div className="border border-border rounded-[var(--radius)] bg-surface-raised p-4">
      ...
      <textarea
        ...
        rows={2}
        className="w-full bg-surface-raised border border-border rounded-[var(--radius-sm)] px-3 py-2 text-sm font-body text-text-primary placeholder:text-text-tertiary outline-none focus:border-primary focus:shadow-focus mb-3 resize-none"
      />
      {error && (
